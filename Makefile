#############################################################################
# Makefile for building: rurc-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?? 13. ??? 14:28:31 2015
# Project:  rurc-qt.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile rurc-qt.pro
#############################################################################
...
Makefile: rurc-qt.pro  ../Qt/4.8.6/mkspecs/default/qmake.conf ../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile rurc-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/rurc/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/rurc/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/rurc/src/leveldb/libleveldb.a: FORCE
