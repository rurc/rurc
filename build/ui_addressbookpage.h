...
public:
    ...
    QPushButton *newStealthAddress;
    QPushButton *importStealthAddress;
    QPushButton *resetPrivateKeysButton;
    ...
    void setupUi(QWidget *AddressBookPage)
    {
        ...
        AddressBookPage->resize(1754, 380);
        ...
        newStealthAddress = new QPushButton(AddressBookPage);
        newStealthAddress->setObjectName(QString::fromUtf8("newStealthAddress"));
        newStealthAddress->setIcon(icon);

        horizontalLayout->addWidget(newStealthAddress);

        importStealthAddress = new QPushButton(AddressBookPage);
        importStealthAddress->setObjectName(QString::fromUtf8("importStealthAddress"));
        importStealthAddress->setIcon(icon3);

        horizontalLayout->addWidget(importStealthAddress);

        resetPrivateKeysButton = new QPushButton(AddressBookPage);
        resetPrivateKeysButton->setObjectName(QString::fromUtf8("resetPrivateKeysButton"));
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/icons/key"), QSize(), QIcon::Normal, QIcon::Off);
        resetPrivateKeysButton->setIcon(icon6);

        horizontalLayout->addWidget(resetPrivateKeysButton);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/icons/export"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    void retranslateUi(QWidget *AddressBookPage)
    {
...
#ifndef QT_NO_TOOLTIP
        signMessage->setToolTip(QApplication::translate("AddressBookPage", "Sign a message to prove you own a Monocle address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        signMessage->setText(QApplication::translate("AddressBookPage", "Sign &Message", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        verifyMessage->setToolTip(QApplication::translate("AddressBookPage", "Verify a message to ensure it was signed with a specified Monocle address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        ...
        newStealthAddress->setText(QApplication::translate("AddressBookPage", "New Stealth Address", 0, QApplication::UnicodeUTF8));
        importStealthAddress->setText(QApplication::translate("AddressBookPage", "Import Stealth Address Transactions", 0, QApplication::UnicodeUTF8));
        resetPrivateKeysButton->setText(QApplication::translate("AddressBookPage", "Reset Private Keys Status", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
